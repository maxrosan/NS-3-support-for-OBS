...
silent only
cd ~/Documents/Sources/trabalhos/redes/ns/ns-allinone-3.11/ns-3.11
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 src/wscript
badd +0 src/csma/model/csma-channel.cc
badd +0 src/csma/wscript
badd +0 src/csma/model/csma-channel.h
silent! argdel *
edit src/wscript
...
33
normal! 04l
tabedit src/csma/model/csma-channel.h
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 36 - ((0 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
36
...
wincmd w
argglobal
edit src/csma/model/csma-channel.cc
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal balloonexpr=
